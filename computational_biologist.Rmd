...
The 4C process creates a lot of data that are not generally organized. So, we created a data pipeline that organizes and gets rid of unwanted data. ![data pipeline](data_pipeline.PNG)
