...
- On the topic of MySQL, we initially created basic MySQL queries, [shown here](Assignment_1.pdf) and as the class progressed we transitioned to more complex SQL statements, [shown here](Assignment_6.pdf). 
